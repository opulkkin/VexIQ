...
/* Tassa ohjelmassa esiintyvan automaattiohjauksen idea on seuraava:
  ...
  Lisaksi rinnalla on toinen task, jossa ledin vari muuttuu tietyn kaavan mukaan "portaattomasti".
...
// main-funktiossa(task One:ssa) kaytettyjen funktioiden prototyypit ovat seuraavassa. Osaa naista funktioista
  ...
  short red, green, blue;
	...
	while (true) {                   // Ikuinen silmukka
	  ...
	  blue = 0;
		...
		while (time1[T4] <= 12750) {   // Tassa silmukassa pyoritaan siis 12,75 s.

      red = 255-time1[T4]/50;      // Punaisen maara pienenee koko ajan

      green = time1[T4]/50;        // Vihrean maara kasvaa koko ajan
		...
		while (time1[T4] <= 12750) {    // Tassa silmukassa pyoritaan siis 12,75 s.
			...
			green = 255-time1[T4]/50;     // Vihrean maara pienenee koko ajan

      blue = time1[T4]/50;					// Sinisen maara kasvaa koko ajan
		...
		while (time1[T4] <= 12750) {    // Tassa silmukassa pyoritaan siis 12,75 s.
			...
			blue = 255-time1[T4]/50;      // Sinisen maara pienenee koko ajan

			red = time1[T4]/50;           // Punaisen maara kasvaa koko ajan
